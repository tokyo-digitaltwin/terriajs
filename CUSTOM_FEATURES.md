...
| Trait         | Type    | Default | Description                                                                                                                                                                   |
| :------------ | :------ | :------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| timeMode | string  |         | WMSからデータを取得する時に、データ取得期間の設定有無を指定するパラメータ。取得期間を設定する場合は“range”を記述する。取得期間を設定しない場合は“instant”を記述する。データカタログに設定がない場合は、取得期間は指定されない。取得期間を設定する場合は“range”を記述する。取得期間を設定しない場合は“instant”を記述する。データカタログに設定がない場合は、取得期間は指定されない。|
