...
export const GLYPHS = {
  ...
  measureArea: require("../../wwwroot/images/icons/measure-area.svg"),
  ...
  pdf: require("../../wwwroot/images/icons/pdf.svg"),
  downloadSquare: require("../../wwwroot/images/icons/download_square.svg"),
};
